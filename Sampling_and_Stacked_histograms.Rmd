...
hist(def$m250, col="lightblue", 
  xlab="Sample mean",
  ylab="Number of samples",
  main="Sample mean frequency by size")
...
```
Interesting, going from 200 to 375 helps but not that much.  The jump to 500 appears to make a good chunk of difference.  I wouldn't shoot past 500 - with a population size of only 4,000 there's only so much good that extra sampling can do you.  Based on these histograms, I would say shoot for 500 if you want to be really precise, but also know that an n of 250 will get you pretty close to the population mean.  Bear in mind, this is all based on you taking a totally random sample from your population, with no replacement.  
